...
let activitiesData: [Activity] = [
    ...
    Activity(
        ...
        image: "hiking",
        title: "Wandelen",
        headline: "Maak samen een wandeling",
        description: "Wandelen kan een belangrijke rol spelen in de behandeling van depressie. Help je vriend(in) een handje en stel eens voor om samen een wandeling te maken. Kies bij voorkeur een route door de natuur. De natuur heeft namelijk een hele rustgevende werking die ervoor kan zorgen dat negatieve gedachtes afnemen.",
        isFavorite: false
    ),
